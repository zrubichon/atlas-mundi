...
module.exports = async function handler(req, res) {
  ...
  const fastTabs = ['overview','chat','ticker','news','country_news','newsdetail','battle'];
  const modelName = fastTabs.includes(tab) ? 'claude-haiku-4-5-20251001' : 'claude-sonnet-4-5';
  const maxTok = ['overview','chat','ticker'].includes(tab) ? 2000 : 3000;
